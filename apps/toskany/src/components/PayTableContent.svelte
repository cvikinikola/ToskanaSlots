...
<div class="pay-table">
	...
	<p class="intro">
		Welcome to the vineyards of {gameDisplayName}. All symbols pay in blocks of
		<strong>minimum 5 symbols</strong> connected horizontally or vertically on a
		<strong>7×7</strong> grid. All wins are multiplied by the current {social ? 'play amount' : 'bet amount'}.
	</p>
