...
<div class="game-rules">
	...
	<p class="lead">
		{gameDisplayName} is set among rolling Tuscan vineyards. All symbols pay in blocks of
		minimum <strong>5 symbols</strong> connected horizontally or vertically. The game is played on
		a <strong>7×7 grid</strong> of symbols (49 positions).
	</p>
