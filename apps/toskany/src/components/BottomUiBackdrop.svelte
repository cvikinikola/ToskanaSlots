<script lang="ts">
	...
	/**
	 * Soft black gradient strip across the bottom of the canvas so the Stake SDK
	 * UI sits on a clean dark surface over the looping vineyard video background.
	 */
...
<Graphics
	...
	draw={(g) => {
		...
		// Solid bottom block over the video background.
