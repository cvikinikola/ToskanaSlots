...
const assets = {
	...
	menu_turbo: sprite(`${MENU_BAR_BUTTONS}/btn_lightning.webp`),
	menu_turbo_active: sprite(`${MENU_BAR_BUTTONS}/btn_turbo.webp`),
	menu_auto_spin: sprite(`${MENU_BAR_BUTTONS}/btn_autospin.webp`),
	...
	menu_buy_bonus_panel: sprite(`${MENU_BAR}/wooden_panel.webp`),
	menu_tumble_history_panel: sprite(`${MENU_BAR_BUTTONS}/paytable_panel.webp`),
