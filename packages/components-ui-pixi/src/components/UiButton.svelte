<script lang="ts">
	...
	// Full-frame PNG plates (plus / minus / turbo / auto-spin) — square fit.
	const imageWidth = $derived(buttonProps.sizes.width * 0.95);
	const imageHeight = $derived(buttonProps.sizes.height * 0.95);
