import { env as envDynamicPublic } from '$env/dynamic/public';

export let PUBLIC_SITE_MODE = envDynamicPublic.PUBLIC_SITE_MODE ?? '';
export let PUBLIC_SENTRY_DSN = envDynamicPublic.PUBLIC_SENTRY_DSN ?? '';
export let PUBLIC_CHROMATIC = envDynamicPublic.PUBLIC_CHROMATIC === 'true';
